...
def display_information():
  ...
  print("             window_height: ", window_height, "pixels", "\t window_width: ", window_width, "pixels")
  print("             color_fps: ", color_fps, "fps")
  print("             depth_fps: ", depth_fps, "fps")
  print("")
  print("Information: Environment Variables")
  print("             Aimming Star ->")
  print("               hor_left1_aim_s: ", hor_left1_aim_s, "\t hor_left1_aim_e: ", hor_left1_aim_e)
  ...
  print("               object_lower_blue = (low_blue_H,low_blue_S, low_blue_V): ", object_lower_blue)
  ...
  print("")
  print("             ESC ->")
  print("               escButton: ", escButton, "(ASCII)")
  print("")
  print("             Position -> ")
  print("               position: ", position)
  print("")
  print("             Velocity ->")
  print("               velocity = (v_x, v_y, v_z): ", velocity)
  print("")
  print("             Window Size -> ")
  print("               window_area_width: ", window_area_width, "pixels")
  print("               window_left: ", window_left, "pixels")
  print("               window_right: ", window_right, "pixels")
  print("               window_mid_left: ", window_mid_left, "pixels")
  print("               window_mid_right: ", window_mid_right, "pixels")
  print("")

def find_distance(depth_frame, x, y):
  return round(depth_frame.get_distance(int(x), int(y)) * 100, 3)
...
def main():
  ...
  try:
    ...
    print("RS -> Error: ", e)
    print("Message: Camera Algorithm: Exception End")
    exit()
  ...
  try:
    ...
    while True:
      ...
      if found:
        ...
        # Distance
        distance = find_distance(depth_frame, x, y)
    ...
    print("Message: Camera object detection: Start -> End!!!")
    # Stop streaming
    pipe.stop()
